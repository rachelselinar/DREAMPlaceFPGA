...
import dreamplacefpga.ops.pin_pos.pin_pos_cpp as pin_pos_cpp
import dreamplacefpga.configure as configure
if configure.compile_configurations["CUDA_FOUND"] == "TRUE": 
    import dreamplacefpga.ops.pin_pos.pin_pos_cuda as pin_pos_cuda
    import dreamplacefpga.ops.pin_pos.pin_pos_cuda_segment as pin_pos_cuda_segment
...
class PinPos(nn.Module):
    ...
    """
    def __init__(self, pin_offset_x, pin_offset_y, pin2node_map, flat_node2pin_map, flat_node2pin_start_map, num_physical_nodes, num_threads, algorithm='segment'):
        """
