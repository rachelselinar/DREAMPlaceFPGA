...
void bind_PyPlaceDB(pybind11::module& m) 
{
    pybind11::class_<DREAMPLACE_NAMESPACE::PyPlaceDB>(m, "PyPlaceDB")
        ...
        .def_readwrite("org_node_x_offset", &DREAMPLACE_NAMESPACE::PyPlaceDB::org_node_x_offset)
        .def_readwrite("org_node_y_offset", &DREAMPLACE_NAMESPACE::PyPlaceDB::org_node_y_offset)
        .def_readwrite("org_node_z_offset", &DREAMPLACE_NAMESPACE::PyPlaceDB::org_node_z_offset)
        ...
        .def_readwrite("pin2org_node_map", &DREAMPLACE_NAMESPACE::PyPlaceDB::pin2org_node_map)
        ...
        .def_readwrite("site_name_map", &DREAMPLACE_NAMESPACE::PyPlaceDB::site_name_map)
        ...
        .def_readwrite("shape_heights", &DREAMPLACE_NAMESPACE::PyPlaceDB::shape_heights)
        .def_readwrite("shape_widths", &DREAMPLACE_NAMESPACE::PyPlaceDB::shape_widths)
        .def_readwrite("shape_types", &DREAMPLACE_NAMESPACE::PyPlaceDB::shape_types)
        .def_readwrite("shape2org_node_map", &DREAMPLACE_NAMESPACE::PyPlaceDB::shape2org_node_map)
        .def_readwrite("flat_shape2org_node_map", &DREAMPLACE_NAMESPACE::PyPlaceDB::flat_shape2org_node_map)
        .def_readwrite("flat_shape2org_node_start_map", &DREAMPLACE_NAMESPACE::PyPlaceDB::flat_shape2org_node_start_map)
        .def_readwrite("shape2cluster_node_start", &DREAMPLACE_NAMESPACE::PyPlaceDB::shape2cluster_node_start)
        .def_readwrite("original_node_is_shape_inst", &DREAMPLACE_NAMESPACE::PyPlaceDB::original_node_is_shape_inst)
